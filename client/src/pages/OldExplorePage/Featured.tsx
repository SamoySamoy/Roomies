...
const cards = [
  {
    ...
    online: <span>85,532 Online</span>,
    members: <span>232,061 Members</span>,
  },
  {
    bg: bg1,
    profile: picture2,
...
const Featured = () => {
  return (
    <div className='pt-6   '>
      ...
      {/* Cards*/}
      <div className='grid grid-cols-1 xs:grid-cols-2   lg:grid-cols-4 gap-y-8 xs:gap-x-2 sm:gap-x-4 mb-4  '>
        {cards.map(card => (
          <Link to='/preview'>
            <Card
              bg={card.bg}

  ...
  return (
    <div className='w-full py-24 md:max-w-[1480px] m-auto flex flex-col items-center justify-center gap-4 max-w-[600px] px-4 md:px-0'>
      <h1 className='py-2  text-3xl font-semibold'>
        Let's join <span className='text-green-500'>Roomies</span> with us
      </h1>
      <Link to={'/register'}>
        <Button className='bg-green-500 transition duration-300 ease-in-out transform hover:scale-110 hover:text-accent-foreground dark:hover:shadow-[0_0_2rem_-0.5rem_#fff8]'>

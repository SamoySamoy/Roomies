...
const Categories = () => {
  ...
  return (
    <Element name='categories' className={`${inView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-[-40px]'} transform transition ease-in-out duration-1000 `}>
      <div ref={ref}>
        <div className='w-full py-20 px-20'>
          <div className='md:max-w-[1480px] m-auto max-w-[600px] px-4 md:px-0'>
            <h1 className='md:leading-[72px] text-3xl font-bold'>
              Explore a variety of <span className='text-emerald-400'>Communities</span> by topic
            </h1>

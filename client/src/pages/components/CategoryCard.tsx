const CategoryCard = ({ icons, title }) => {
  return (
    <div
      className='md:p-4 p-2 shadow-lg rounded-xl flex items-center gap-4 justify-between border border-transparent hover:border-green-400 hover:cursor-pointer

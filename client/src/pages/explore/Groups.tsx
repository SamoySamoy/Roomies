  ...
  return (
    <div className="hidden sm:flex bg-[#212226] w-[4rem] shrink-0 h-screen sticky top-0 pt-6">
      ...
      <div className="flex flex-col items-center w-full space-y-4">
        {/* Discord */}
        {/* <Link to="/"> */}
          <div data-tooltip-target="tooltip-right" data-tooltip-placement="right" className="bg-[#36393f] w-3/4 p-0 rounded-[1.3rem] hover:bg-[#5865f2] hover:rounded-2xl cursor-pointer">
            <img
              src={dc}

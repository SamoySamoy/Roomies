  ...
  return (
    <div className='fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-90'>
      <div className='w-11/12 md:w-1/2 lg:w-2/5 xl:w-1/3'>
        <div className='bg-emerald-500 h-10 rounded-t-md relative border border-emerald-500'>
        ...
        <div className=' p-4 rounded-b-md border border-zinc-400'>
          <div className=' bg-zinc-800 rounded-md p-4'>
            <div className='flex items-center pb-4'>
              ...
              <button className='text-white px-2 py-1 rounded-md text-sm ml-auto bg-emerald-500 duration-300 hover:scale-105'>
                Edit Avatar
              </button>
            </div>
            ...
            <div className='grid grid-cols-1 gap-4 mt-4'>
              ...
              <div className='flex justify-center'>
                <button className='w-[50%] text-white py-2 rounded-md bg-emerald-500 duration-300 hover:scale-105'>
                  Change Password
                </button>
              </div>
              <div className='flex justify-center'>
